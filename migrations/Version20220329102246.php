 ...
 */
final class Version20220329102246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE proposer DROP FOREIGN KEY FK_21866C15D1569148');
        $this->addSql('DROP INDEX IDX_21866C15D1569148 ON proposer');
        $this->addSql('ALTER TABLE proposer CHANGE un_hotel_id hotelid INT NOT NULL');
        $this->addSql('ALTER TABLE proposer ADD CONSTRAINT FK_21866C15631066A6 FOREIGN KEY (hotelid) REFERENCES hotel (id)');
        $this->addSql('CREATE INDEX IDX_21866C15631066A6 ON proposer (hotelid)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_21866C15631066A6 ON proposer');
        $this->addSql('ALTER TABLE proposer CHANGE hotelid un_hotel_id INT NOT NULL');
        $this->addSql('ALTER TABLE proposer ADD CONSTRAINT FK_21866C15D1569148 FOREIGN KEY (un_hotel_id) REFERENCES hotel (id)');
        $this->addSql('CREATE INDEX IDX_21866C15D1569148 ON proposer (un_hotel_id)');
