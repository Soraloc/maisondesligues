 ...
 */
final class Version20220511140545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE log CHANGE numlicence numlicence VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE log CHANGE login login VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE numlicence numlicence INT NOT NULL, CHANGE adresseip adresseip VARCHAR(15) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE codeerreur codeerreur VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
