 ...
 */
final class Version20220505205322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liaisonateliertheme (idatelier INT NOT NULL, idtheme INT NOT NULL, INDEX IDX_168309E63EBF4A4D (idatelier), INDEX IDX_168309E641708B11 (idtheme), PRIMARY KEY(idatelier, idtheme)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE compte (id INT AUTO_INCREMENT NOT NULL, identifiant VARCHAR(70) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, mail_valide TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_CFF65260C90409EC (identifiant), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
