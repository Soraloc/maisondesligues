 ...
 */
final class Version20220503103624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte CHANGE username identifiant VARCHAR(70) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte ADD username VARCHAR(70) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP identifiant, CHANGE password password VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
