 ...
 */
final class Version20220511132050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte DROP mail_valide');
        $this->addSql('ALTER TABLE log CHANGE adresse_ip adresse_ip VARCHAR(15) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte ADD mail_valide TINYINT(1) DEFAULT 0 NOT NULL, CHANGE identifiant identifiant VARCHAR(70) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE password password VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE log CHANGE login login VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE adresse_ip adresse_ip VARCHAR(13) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE code_erreur code_erreur VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
