...
class Log
{
    ...
    /**
     * @ORM\Column(type="date", name="dateconnexion")
     */
    private $dateConnexion;

    /**
     * @ORM\Column(type="string", length=15, name="adresseip")
     */
    private $adresseIP;

    /**
     * @ORM\Column(type="boolean", name="connexionroue")
     */
    private $connexionRouE;

    /**
     * @ORM\Column(type="string", length=255, name="codeerreur")
     */
    private $codeErreur;
    ...
    public function getConnexionRouE(): ?string
    {
        return $this->connexionRouE;
    }

    public function setConnexionRouE(string $connexionRouE): self
    {
